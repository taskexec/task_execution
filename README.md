This is a Java framework of modular design. It can be used for the command-line tool or the backend service and can be executed in the multi-thread environment.
